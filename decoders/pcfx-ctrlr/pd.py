...
class Decoder(srd.Decoder):
    ...
    annotations = (
        ('7', 'start', 'Start'),                    # 0 = (row 1)
        ('1', 'reset', 'Reset'),                    # 1 = (row 1)
        ('3', 'bits', 'Bits'),                      # 2 = (row 2)
        ('10', 'outbits', 'Outbound Bits'),         # 3 = (row 2)
        ('106', 'bytes', 'Bytes'),                  # 4 = 
        ('109', 'words', 'Words'),                  # 5 = 
        ('12', 'ctrldata', 'Controller Data'),      # 6 = 
        ('14', 'ctrlpad', 'Joypad Controller'),     # 7 = 
        ('15', 'ctrltap', 'Multitap Controller'),   # 8 = 
        ('17', 'ctrlmouse', 'Mouse Controller'),    # 9 = 
        ('16', 'ctrlunkn', 'Unknown Controller'),   # 10 = 
        ('1000', 'warning', 'Warnings'),            # 11 = (row 3)
    )
    annotation_rows = (
        ('start', 'Start', (0,1,)),
        ('bits', 'Bits', (2,3,)),
